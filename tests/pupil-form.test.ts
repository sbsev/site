...
test('pupil signup page displays correctly with all required elements', async ({ page }) => {
  ...
  await expect(page.locator('text=Wir freuen uns über dein Interesse!')).toBeVisible()
